...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'virtual_tactile_pad' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rayann/Desktop/virtual_tactile_pad/ros_ws/install/lib;/home/rayann/Desktop/virtual_tactile_pad/ros_ws/devel/lib;/home/rayann/miniconda3/envs/ros_env/lib)
